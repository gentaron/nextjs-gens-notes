  ...
  return (
    <>
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-hero opacity-70 animate-gradient-move"></div>

        <div className="relative z-10 text-center p-8">
          <h1 className="text-6xl md:text-8xl font-extrabold leading-tight mb-4 text-gradient animate-fade-in-up">
            Gens Notes
          </h1>
          <p className="text-xl md:text-2xl text-[var(--pure-white)] mb-8 animate-fade-in-up animation-delay-200">
            Your source for insightful articles and captivating stories.
          </p>
          <Link
            href="/blog"
            className="inline-block px-8 py-4 bg-gradient-to-r from-[var(--electric-purple)] to-[var(--hot-pink)] text-[var(--pure-white)] font-bold text-lg rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 animate-fade-in-up animation-delay-400"
          >
            Explore Blog
          </Link>
        </div>
